...
class TestAPI(unittest.TestCase):
    ...
    def test_predict(self):
        ...
        self.assertIn("prediction", data, "Response does not contain 'prediction'")
    ...
    def test_predict_probabilities(self):
        ...
        data = json.loads(response.get_data(as_text=True))
        self.assertIn(
            "probabilities", data, "Response does not contain 'probabilities'"
        )
    ...
    def test_get_confusion_matrix(self):
        ...
        data = json.loads(response.get_data(as_text=True))
        self.assertIn(
            "confusion_matrix", data, "Response does not contain 'confusion_matrix'"
        )
    ...
    def test_get_feature_importance(self):
        ...
        data = json.loads(response.get_data(as_text=True))
        self.assertIn(
            "feature_importance", data, "Response does not contain 'feature_importance'"
        )
    ...
    def test_get_feature_names(self):
        ...
        data = json.loads(response.get_data(as_text=True))
        self.assertIn(
            "feature_names", data, "Response does not contain 'feature_names'"
        )
