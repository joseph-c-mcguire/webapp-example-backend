...
class TestSplitData(unittest.TestCase):
    ...
    def test_split_data(self):
        ...
        self.assertTrue(
            os.path.exists(self.train_val_file_path),
        ...
        self.assertEqual(
            len(test_data), 2, f"Expected 2 rows in test data, got {len(test_data)}"
        )
        ...
        self.assertIn(
            "Feature1", test_data.columns, "Feature1 not found in test data columns"
        )
        self.assertIn(
            "Feature2", test_data.columns, "Feature2 not found in test data columns"
        )
        self.assertIn(
            "Target", test_data.columns, "Target not found in test data columns"
        )
